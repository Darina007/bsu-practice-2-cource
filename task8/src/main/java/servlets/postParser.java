...
public interface postParser extends jsonParser {
    default long parseId(JsonObject object) {
        return object.get(ConstantDictionary.KEY_ID).getAsLong();
    }

    default long parseUserId(JsonObject object) {
        return object.get(ConstantDictionary.KEY_USER_ID).getAsLong();
    }
    ...
    default List<Long> parseLikes(JsonObject object) {
        Gson g = new Gson();
